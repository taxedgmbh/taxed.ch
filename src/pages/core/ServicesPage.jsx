          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-dark-gray/80">
                We also offer tax planning and business tax services for expat-owned businesses and professionals with complex tax situations. Our primary expertise is in expatriate tax matters.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
