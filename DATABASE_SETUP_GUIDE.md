# 🗄️ **DATABASE SETUP GUIDE - phpMyAdmin**

## 🎯 **QUICK SETUP (5 MINUTES)**

Follow these exact steps to set up your secure client portal database in phpMyAdmin.
...
1. **Open your browser** and go to: **https://taxed.ch/phpmyadmin**
2. **Login** with your Hostinger database credentials:
